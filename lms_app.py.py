...
if menu == "Home":
    ...
    uploaded_file = st.file_uploader("Unggah Dataset Peserta (Excel)", type=["xlsx"], key="prediksi_upload")
    ...
    if uploaded_file:
        ...
        if expected_columns.issubset(df.columns):
            ...
            st.error("Dataset tidak sesuai. Kolom tidak lengkap.")
    else:
        st.info("Silakan unggah file Excel untuk halaman ini.")
